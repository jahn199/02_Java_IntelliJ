...
public class MapService {
    ...
    public void method1(){
        ...
        System.out.println("[EU]   지우기 : " + 나라들.remove("EU"));//없는 키를 주우려하면 null 반환 == 지울게 없다는 의미
    ...
    //Map의 경우에도 index가 없기 때문에 Map.keySet()을 이용해서 접근
    public void method2(){
        ...
        for (String key : set) {//set에 저장된 [집,63빌딩,학원,롯데타워]를
            //순차적으로 key에 저장, 저장된 키에 해당하는 값을
            //map.get(key)를 이용해서 키에 해당하는 value 값을 get 하겠다 작성
            System.out.println(key + " : " + map.get(key));
        }
    }

    //Map의 경우에도 index가 없기 때문에 Map.entrySet()을 이용해서 접근
    public void method3(){
