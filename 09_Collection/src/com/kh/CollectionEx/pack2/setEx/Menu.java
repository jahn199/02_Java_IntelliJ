...
public class Menu {
    ...
    public boolean equals(Object o) {
        ...
        Menu menu = (Menu) o;
        //만약에 메뉴에 들어올 값이 맞음
        //id값이 같은지 확인                    가격이 같은지 확인                             이름이 같은지 확인
    ...
    //주민등록번호, 학번, 은행 번호표와 같이 암호화 처리를 진행해야 할 때 사용
    @Override
    public int hashCode() {
    ...
    //재정의 해서 사용할 경우 객체 안에서 특정 필드 값이 같을 때 논리적으로 같다고 정의하고 비교 내요을 구현
